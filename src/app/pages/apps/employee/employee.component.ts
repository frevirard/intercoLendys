...
const employees = [
  ...
  },
  {
    ...
    Email: 'sam@lendys.com',
    Mobile: 7788838,
    DateOfJoining: new Date('02-2-2020'),
    Salary: "Contrôle de gestion",
    Projects: 10,
